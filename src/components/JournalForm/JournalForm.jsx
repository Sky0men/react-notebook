	...
	return (
		<form className={styles['journal-form']} onSubmit={addJournalItem}>
			...
			<div className={styles['form-row']}>
				...
				<input type='date' ref={dateRef} name='date' onChange={onChange} value={values.date} id="date" className={cn(styles['input'], {
			...
			<textarea name="post" ref={postRef} id="" cols="30" rows="10" onChange={onChange} value={values.post} className={cn(styles['input'], {
